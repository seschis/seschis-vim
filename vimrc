...
map gp :bp<cr>
map gd :bd<cr>
" same as above, but using the leaderkey (;)
...
" set colorcolumn=+1
" set textwidth=80  " in the future, should base this on filetype
" draw warning line as darkgrey
" hi ColorColumn ctermbg=darkgrey guibg=red

" show line numbers in gutter. relativenumber makes scrolling slow.
set number
" change to show non-relative numbers when focus leaves window
